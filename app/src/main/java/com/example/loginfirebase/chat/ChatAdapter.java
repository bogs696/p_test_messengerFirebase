...
import com.example.loginfirebase.Settings;
...
public class ChatAdapter extends RecyclerView.Adapter <ChatAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (!chatMessage.isSentByMe()) {
            ...
            color = fetchColor(Settings.getInstance().getInterlocutorColorMessage());
        } else{
            color = fetchColor(Settings.getInstance().getYouColorMessage());
